...
This release includes third-party open-source components used by the VeriTurn Studio
desktop app and runtime tools. Each component remains governed by its own license; this
list is generated from local Rust (`cargo metadata`) and npm (`node_modules`) dependency
metadata at export time and is best-effort, not a substitute for each project's own
license text.

## Rust Dependencies (507)
...
- @csstools/css-color-parser@4.1.3 — MIT
...
- @javascript-obfuscator/escodegen@2.4.1 — BSD-2-Clause
...
- @vercel/blob@2.5.0 — Apache-2.0
- @vercel/cli-config@0.2.0 — Apache-2.0
- @vercel/cli-exec@1.0.0 — Apache-2.0
- @vercel/oidc@3.8.0 — Apache-2.0
...
- isexe@2.0.0 — ISC
- javascript-obfuscator@5.4.3 — BSD-2-Clause
- jose@5.10.0 — MIT
- js-string-escape@1.0.1 — MIT
- js-tokens@4.0.0 — MIT
- jsdom@29.1.1 — MIT
- levn@0.3.0 — MIT
- libphonenumber-js@1.13.8 — MIT
